...
export type GetTimelineEventsQuery = { __typename?: 'Query', thread?: { __typename?: 'Thread', id: string, timelineEntries: { __typename?: 'TimelineEntryConnection', edges: Array<{ __typename?: 'TimelineEntryEdge', cursor: string, node: { __typename?: 'TimelineEntry', id: string, customerId: string, threadId: string, llmText?: string | null, timestamp: (
            ...
            & { ' $fragmentRefs'?: { 'DateTimeFragment': DateTimeFragment } }
              ...
              { __typename?: 'DateTime' }
              & { ' $fragmentRefs'?: { 'DateTimeFragment': DateTimeFragment } }
            ) | null, attachments: Array<{ __typename?: 'Attachment', id: string, fileName: string, fileMimeType: string, fileSize: { __typename?: 'FileSize', bytes: number } }> } | { __typename: 'CustomEntry', externalId?: string | null, title: string, type?: string | null, attachments: Array<{ __typename?: 'Attachment', id: string, fileName: string, fileMimeType: string, fileSize: { __typename?: 'FileSize', bytes: number } }> } | { __typename: 'CustomerEventEntry', timelineEventId: string, title: string, customerId: string, externalId?: string | null } | { __typename: 'DiscordMessageEntry', markdownContent?: string | null, discordMessageId: string, discordMessageLink: string, customerId: string, attachments: Array<{ __typename?: 'Attachment', id: string, fileName: string, fileMimeType: string, fileSize: { __typename?: 'FileSize', bytes: number } }> } | { __typename: 'EmailEntry', emailId: string, subject?: string | null, textContent?: string | null, hasMoreTextContent: boolean, fullTextContent?: string | null, markdownContent?: string | null, hasMoreMarkdownContent: boolean, fullMarkdownContent?: string | null, authenticity: EmailAuthenticity, sendStatus?: EmailSendStatus | null, isStartOfThread: boolean, sentAt?: (
              { __typename?: 'DateTime' }
              & { ' $fragmentRefs'?: { 'DateTimeFragment': DateTimeFragment } }
            ) | null, receivedAt?: (
              { __typename?: 'DateTime' }
              & { ' $fragmentRefs'?: { 'DateTimeFragment': DateTimeFragment } }
                ...
                { __typename?: 'DateTime' }
                & { ' $fragmentRefs'?: { 'DateTimeFragment': DateTimeFragment } }
              ), recipient: { __typename?: 'EmailParticipant', name?: string | null, email: string } }> } | { __typename: 'HelpCenterAiConversationMessageEntry', messageId: string, helpCenterId: string, messageMarkdown: string } | { __typename: 'LinearIssueThreadLinkStateTransitionedEntry', linearIssueId: string, previousLinearStateId: string, nextLinearStateId: string } | { __typename: 'MSTeamsMessageEntry', text: string, markdownContent?: string | null, msTeamsMessageId: string, msTeamsMessageLink: string, customerId: string, attachments: Array<{ __typename?: 'Attachment', id: string, fileName: string, fileMimeType: string, fileSize: { __typename?: 'FileSize', bytes: number } }> } | { __typename: 'NoteEntry', noteId: string, text: string, markdown?: string | null, attachments: Array<{ __typename?: 'Attachment', id: string, fileName: string, fileMimeType: string, fileSize: { __typename?: 'FileSize', bytes: number } }> } | { __typename: 'ServiceLevelAgreementStatusTransitionedEntry', previousSLAStatus: ServiceLevelAgreementStatus, nextSLAStatus: ServiceLevelAgreementStatus } | { __typename: 'SlackMessageEntry', slackMessageLink: string, slackWebMessageLink: string, text: string, customerId: string, relatedThread?: { __typename?: 'SlackMessageEntryRelatedThread', threadId: string } | null, attachments: Array<{ __typename?: 'Attachment', id: string, fileName: string, fileMimeType: string, fileSize: { __typename?: 'FileSize', bytes: number } }>, lastEditedOnSlackAt?: (
              { __typename?: 'DateTime' }
              & { ' $fragmentRefs'?: { 'DateTimeFragment': DateTimeFragment } }
              ...
              { __typename?: 'DateTime' }
              & { ' $fragmentRefs'?: { 'DateTimeFragment': DateTimeFragment } }
            ) | null, reactions: Array<{ __typename?: 'SlackReaction', name: string, imageUrl?: string | null, actors: Array<{ __typename: 'CustomerActor', customerId: string, customer: { __typename?: 'Customer', fullName: string } } | { __typename: 'DeletedCustomerActor' } | { __typename: 'MachineUserActor' } | { __typename: 'SystemActor' } | { __typename: 'UserActor', userId: string, user: { __typename?: 'User', publicName: string } }> }> } | { __typename: 'ThreadAdditionalAssigneesTransitionedEntry', previousAssignees: Array<{ __typename?: 'MachineUser', id: string, fullName: string } | { __typename?: 'System', id: string } | { __typename?: 'User', id: string, fullName: string }>, nextAssignees: Array<{ __typename?: 'MachineUser', id: string, fullName: string } | { __typename?: 'System', id: string } | { __typename?: 'User', id: string, fullName: string }> } | { __typename: 'ThreadAssignmentTransitionedEntry', previousAssignee?: { __typename?: 'MachineUser', id: string, fullName: string } | { __typename?: 'System', id: string } | { __typename?: 'User', id: string, fullName: string } | null, nextAssignee?: { __typename?: 'MachineUser', id: string, fullName: string } | { __typename?: 'System', id: string } | { __typename?: 'User', id: string, fullName: string } | null } | { __typename: 'ThreadDiscussionEntry', slackChannelName: string, customerId: string, threadDiscussionId: string, slackMessageLink: string } | { __typename: 'ThreadDiscussionResolvedEntry', slackChannelName: string, customerId: string, threadDiscussionId: string, slackMessageLink: string, resolvedAt: (
              { __typename?: 'DateTime' }
              & { ' $fragmentRefs'?: { 'DateTimeFragment': DateTimeFragment } }
            ) } | { __typename: 'ThreadEventEntry', timelineEventId: string, title: string, customerId: string, externalId?: string | null } | { __typename: 'ThreadLabelsChangedEntry', previousLabels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, description?: string | null, icon?: string | null, color?: string | null } }>, nextLabels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, description?: string | null, icon?: string | null, color?: string | null } }> } | { __typename: 'ThreadLinkUpdatedEntry', threadLink: { __typename?: 'GenericThreadLink', id: string, threadId: string, title: string, url: string, description?: string | null, status: ThreadLinkStatus } | { __typename?: 'JiraIssueThreadLink', id: string, threadId: string, title: string, url: string, description?: string | null, status: ThreadLinkStatus } | { __typename?: 'LinearIssueThreadLink', id: string, threadId: string, title: string, url: string, description?: string | null, status: ThreadLinkStatus } | { __typename?: 'PlainThreadThreadLink', id: string, threadId: string, title: string, url: string, description?: string | null, status: ThreadLinkStatus }, previousThreadLink: { __typename?: 'GenericThreadLink', id: string, threadId: string, title: string, url: string, description?: string | null, status: ThreadLinkStatus } | { __typename?: 'JiraIssueThreadLink', id: string, threadId: string, title: string, url: string, description?: string | null, status: ThreadLinkStatus } | { __typename?: 'LinearIssueThreadLink', id: string, threadId: string, title: string, url: string, description?: string | null, status: ThreadLinkStatus } | { __typename?: 'PlainThreadThreadLink', id: string, threadId: string, title: string, url: string, description?: string | null, status: ThreadLinkStatus } } | { __typename: 'ThreadPriorityChangedEntry', previousPriority: number, nextPriority: number } | { __typename: 'ThreadStatusTransitionedEntry', nextStatus: ThreadStatus } } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null } } } | null };
