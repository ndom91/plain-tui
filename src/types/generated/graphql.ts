...
export type AutoresponderCondition =
...
export type CustomTimelineEntryComponent =
  | ComponentBadge
  | ComponentContainer
  | ComponentCopyButton
  | ComponentDivider
...
export type CustomerCardComponent =
  | ComponentBadge
  | ComponentContainer
  | ComponentCopyButton
  | ComponentDivider
...
export type CustomerCardInstanceChangesResult =
...
export type CustomerSurveyCondition =
...
export type HelpCenterAuthMechanism =
  ...
  customers: {
    ...
    edges: Array<{
      ...
      node: {
        ...
        email: { __typename?: 'EmailAddress'; email: string; isVerified: boolean }
        company?: { __typename?: 'Company'; id: string; name: string } | null
        createdAt: { __typename?: 'DateTime' } & {
          ' $fragmentRefs'?: { DateTimeFragment: DateTimeFragment }
        }
        updatedAt: { __typename?: 'DateTime' } & {
          ' $fragmentRefs'?: { DateTimeFragment: DateTimeFragment }
        }
      }
    }>
...
export type GetThreadDetailsQuery = {
  __typename?: 'Query'
  thread?: {
    __typename?: 'Thread'
    id: string
    ...
    status: ThreadStatus
    priority: number
    statusChangedAt: { __typename?: 'DateTime' } & {
      ' $fragmentRefs'?: { DateTimeFragment: DateTimeFragment }
    }
    createdAt: { __typename?: 'DateTime' } & {
      ' $fragmentRefs'?: { DateTimeFragment: DateTimeFragment }
    ...
    customer: {
      ...
      id: string
      fullName: string
      email: { __typename?: 'EmailAddress'; email: string }
          ...
          entry:
            | {
                ...
                attachments: Array<{
                  ...
                  fileName: string
                  fileMimeType: string
                  fileSize: { __typename?: 'FileSize'; bytes: number }
                }>
              }
            | {
                __typename: 'CustomEntry'
            ...
            | {
                ...
                receivedAt?:
                  ...
                  | null
                from: { __typename?: 'EmailParticipant'; name?: string | null; email: string }
                to: { __typename?: 'EmailParticipant'; name?: string | null; email: string }
                additionalRecipients: Array<{
                  __typename?: 'EmailParticipant'
                  name?: string | null
                  email: string
                }>
                hiddenRecipients: Array<{
                  __typename?: 'EmailParticipant'
                  name?: string | null
                  email: string
                }>
            ...
            | {
                __typename: 'ServiceLevelAgreementStatusTransitionedEntry'
                previousSLAStatus: ServiceLevelAgreementStatus
                nextSLAStatus: ServiceLevelAgreementStatus
              }
            | {
                __typename: 'SlackMessageEntry'
                ...
                reactions: Array<{
                  ...
                  actors: Array<
                    | {
                        __typename: 'CustomerActor'
                        customerId: string
                        customer: { __typename?: 'Customer'; fullName: string }
                      }
                    | { __typename: 'DeletedCustomerActor' }
                    | { __typename: 'MachineUserActor' }
                    | { __typename: 'SystemActor' }
                    | {
                        __typename: 'UserActor'
                        userId: string
                        user: { __typename?: 'User'; publicName: string }
                      }
                  >
                }>
              }
            ...
            | {
                ...
                threadDiscussionId: string
                slackMessageLink: string
                resolvedAt: { __typename?: 'DateTime' } & {
                  ' $fragmentRefs'?: { DateTimeFragment: DateTimeFragment }
                }
              }
            | {
            ...
            | { __typename: 'ThreadStatusTransitionedEntry'; nextStatus: ThreadStatus }
        }
      }>
      pageInfo: {
        __typename?: 'PageInfo'
...
export type GetWorkspaceQuery = {
  __typename?: 'Query'
  myWorkspace?: { __typename?: 'Workspace'; id: string; name: string; publicName: string } | null
}

export type DateTimeFragment = { __typename: 'DateTime'; iso8601: string } & {
  ' $fragmentName'?: 'DateTimeFragment'
}
  ...
  definitions: [
    {
      ...
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'DateTime' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
          { kind: 'Field', name: { kind: 'Name', value: 'iso8601' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<DateTimeFragment, unknown>
...
export const GetThreadDetailsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'priority' } },
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'FragmentSpread', name: { kind: 'Name', value: 'DateTime' } },
                    ],
                  },
                },
                {
...
} as unknown as DocumentNode<GetThreadDetailsQuery, GetThreadDetailsQueryVariables>
      ...
      variableDefinitions: [
        {
          ...
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'ThreadsFilter' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'sortBy' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'ThreadsSort' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'first' } },
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetTimelineEvents' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'threadId' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'timelineEntries' },
                  arguments: [
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'first' },
                          ...
                          selections: [
                            {
                              ...
                              selectionSet: {
                                ...
                                selections: [
                                  ...
                                  { kind: 'Field', name: { kind: 'Name', value: 'llmText' } },
                                  {
                                    kind: 'Field',
                                    ...
                                    selectionSet: {
                                      ...
                                      selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'UserActor' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'MachineUserActor' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'machineUserId' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'machineUser' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'CustomerActor' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                    ...
                                    selectionSet: {
                                      ...
                                      selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'ChatEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                alias: { kind: 'Name', value: 'chatText' },
                                              ...
                                              },
                                              {
                                                ...
                                                selectionSet: {
                                                  ...
                                                  selections: [
                                                    ...
                                                    {
                                                      kind: 'Field',
                                                      name: { kind: 'Name', value: 'fileMimeType' },
                                                    },
                                                  ],
                                                },
                                              },
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'EmailEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'hasMoreTextContent' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'fullTextContent' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'markdownContent' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: {
                                                  kind: 'Name',
                                                  value: 'hasMoreMarkdownContent',
                                                },
                                              },
                                              {
                                                kind: 'Field',
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'authenticity' },
                                              },
                                              {
                                                kind: 'Field',
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'isStartOfThread' },
                                              },
                                              {
                                                kind: 'Field',
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'hiddenRecipients' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'bounces' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                                      kind: 'Field',
                                                      name: { kind: 'Name', value: 'bouncedAt' },
                                                      selectionSet: {
                                                        kind: 'SelectionSet',
                                                        selections: [
                                                          {
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'NoteEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'CustomEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'SlackMessageEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'relatedThread' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'SlackReplyEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'ThreadEventEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'CustomerEventEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'ThreadAssignmentTransitionedEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'previousAssignee' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'nextAssignee' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'ThreadAdditionalAssigneesTransitionedEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'previousAssignees' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'ThreadStatusTransitionedEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'nextStatus' },
                                              },
                                            ],
                                          },
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'ThreadPriorityChangedEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'previousPriority' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'nextPriority' },
                                              },
                                            ],
                                          },
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'ThreadLabelsChangedEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'previousLabels' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'nextLabels' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'LinearIssueThreadLinkStateTransitionedEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'linearIssueId' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: {
                                                  kind: 'Name',
                                                  value: 'previousLinearStateId',
                                                },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'nextLinearStateId' },
                                              },
                                            ],
                                          },
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'ServiceLevelAgreementStatusTransitionedEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                alias: { kind: 'Name', value: 'previousSLAStatus' },
                                                name: { kind: 'Name', value: 'previousStatus' },
                                              },
                                              {
                                                kind: 'Field',
                                                alias: { kind: 'Name', value: 'nextSLAStatus' },
                                                name: { kind: 'Name', value: 'nextStatus' },
                                              },
                                            ],
                                          },
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'ThreadDiscussionEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'slackChannelName' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'customerId' },
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'threadDiscussionId' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'slackMessageLink' },
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'ThreadDiscussionResolvedEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'MSTeamsMessageEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'msTeamsMessageId' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'msTeamsMessageLink' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'customerId' },
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'ThreadLinkUpdatedEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'threadLink' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'previousThreadLink' },
                                                selectionSet: {
                                                  kind: 'SelectionSet',
                                                  selections: [
                                                    {
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            kind: 'NamedType',
                                            name: { kind: 'Name', value: 'DiscordMessageEntry' },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'discordMessageLink' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'customerId' },
                                        ...
                                        },
                                        {
                                          ...
                                          typeCondition: {
                                            ...
                                            name: {
                                              kind: 'Name',
                                              value: 'HelpCenterAiConversationMessageEntry',
                                            },
                                          },
                                          selectionSet: {
                                            kind: 'SelectionSet',
                                            selections: [
                                              ...
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'helpCenterId' },
                                              },
                                              {
                                                kind: 'Field',
                                                alias: { kind: 'Name', value: 'messageMarkdown' },
                                                name: { kind: 'Name', value: 'markdown' },
                                              },
                                            ],
                                          },
...
} as unknown as DocumentNode<GetTimelineEventsQuery, GetTimelineEventsQueryVariables>
